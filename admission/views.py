...
class StudentAdmissionViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        if serializer.is_valid():
            ...
            ud = data['user']
            user, b = User.objects.get_or_create(email=ud['email'],
            ...
            Address.objects.get_or_create(content_type=c, object_id=user.id,
                    defaults={'province': data['address_detail']['province'],
            ...
            if detail:
                UserDetail.objects.get_or_create(user_id=user.id,
                                                    defaults={'blood_group': detail.get('blood_group',''),
            ...
            StudentAdmission.objects.get_or_create(student_id=student.id,
                                                    defaults={'course_id': data['course'],
